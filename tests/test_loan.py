...
class TestLoan(unittest.TestCase):
    ...
    def test_cost_loan_analysis(self):
        ...
        df_debt = Debt().build_dataframe()
        df_stats0 = loan.Loan.actives[0].stats
        res = loan.get_cost_loan_analysis(end_date='2020-01-31')
        self.assertEqual(len(res["loan"]), 3, "Len should be 3")
        self.assertEqual(res["cost_diff"][0], 0.1811, "Should be 0.1811")
        self.assertEqual(res["cost_diff"][1], -0.2518, "Should be -0.2518")
        self.assertEqual(res["cost_diff"][2], -0.0707, "Should be -0.0707")
