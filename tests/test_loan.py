...
class TestLoan(unittest.TestCase):
    ...
    def test_multiple_updates_in_borrowed_cad_multiple_updates_same_day(self):
        ...
        self.assertEqual(len(df_stats['cad_borrowed'].unique()), 4,
                         'Should be 4 updates in cad borrowed')
        self.assertEqual(df_stats[df_stats['date'] == '2019-11-01']['cad_borrowed'].values[0],
                         10000, 'Should be 1000 in cad borrowed')
        self.assertEqual(df_stats[df_stats['date'] == '2019-11-20']['cad_borrowed'].values[0],
                         20000, 'Should be 1000 in cad borrowed')
        self.assertEqual(df_stats[df_stats['date'] == '2019-11-21']['cad_borrowed'].values[0],
                         15000, 'Should be 1000 in cad borrowed')
        self.assertEqual(df_stats[df_stats['date'] == '2019-11-22']['cad_borrowed'].values[0],
                         35000, 'Should be 1000 in cad borrowed')
