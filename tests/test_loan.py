...
class TestLoan(unittest.TestCase):
    ...
    def test_multiple_loans_multiple_cad_borrowed_increases(self):
        ...
        loan.init_loans()
        self.assertEqual(loan.Loan.actives[0].current_debt_cad, 10100,
                         'Should be 10100 in current cad debt (w/ $100 admin fee)')
        self.assertEqual(loan.Loan.actives[1].current_debt_cad, 6200,
                         'Should be 6200 in current cad debt (w/ $200 admin fee')
        ...
        self.assertEqual(df_stats0[df_stats0['date'] == '2019-11-01']['debt_cad'].values[0],
                         1100, 'Should be 1100 in debt_cad')
        ...
        self.assertEqual(df_stats0[df_stats0['date'] == '2019-11-05']['debt_cad'].values[0],
                         3100, 'Should be 3100 in debt_cad')
        ...
        self.assertEqual(df_stats0[df_stats0['date'] == '2019-11-10']['debt_cad'].values[0],
                         6100, 'Should be 6100 in debt_cad')
    ...
    def test_multiple_loans_multiple_updates_in_collateral_and_cad_borrowed(self):
        ...
        self.assertEqual(loan.Loan.actives[1].current_collateral, 10.0,
                         'Should be 10.0 in current collateral')
        self.assertEqual(loan.Loan.actives[0].current_debt_cad, 3100,
                         'Should be 3100 in current cad debt')
        self.assertEqual(loan.Loan.actives[1].current_debt_cad, 6200,
                         'Should be 6200 in current cad debt')
    ...
    def test_collateralization_ratio(self):
        ...
        self.assertEqual(round(df_stats0[df_stats0['date'] == '2019-11-02']['coll_ratio'].values[0], 1),
                         3.0, 'Should be 3.0 in coll_ratio')
    ...
    def test_debt_dataframe(self):
        ...
        self.assertEqual(df_debt[df_debt['date'] == '2019-12-06']['debt_cad'].values[0],
                         40040, 'Debt cad should be 40040')
        self.assertEqual(df_debt[df_debt['date'] == '2019-12-07']['debt_cad'].values[0],
                         90060, 'Debt cad should be 70000')
        ...
        self.assertEqual(df_debt[df_debt['date'] == '2019-12-07']['total_liab_cad'].values[0],
                         90148.9, 'Total liabilities CAD do not match')
    ...
    def test_prod_loan1(self):
        cfg.set_test_mode('loans_13.csv')
        loan.init_loans()
        df_debt = Debt().build_dataframe()
        self.assertEqual(round(df_debt[df_debt['date'] == '2019-12-17']['total_liab_cad'].values[0], 1),
                         10864.4, 'Total liabilities CAD do not match')

    def test_prod_loan2(self):
        cfg.set_test_mode('loans_14.csv')
        loan.init_loans()
        df_debt = Debt().build_dataframe()
        self.assertEqual(round(df_debt[df_debt['date'] == '2019-12-17']['total_liab_cad'].values[0], 1),
                         43189.3, 'Total liabilities CAD do not match')
