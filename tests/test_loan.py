...
class TestLoan(unittest.TestCase):
    ...
    def test_multiple_loans_multiple_cad_borrowed_increases(self):
        ...
        loan.init_loans()
        self.assertEqual(loan.Loan.active_loans[0].current_debt_cad, 10000,
                         'Should be 10000 in current cad debt')
        self.assertEqual(loan.Loan.active_loans[1].current_debt_cad, 6000,
                         'Should be 6000 in current cad debt')
        self.assertEqual(len(loan.Loan.active_loans[0].debt_history_cad), 4, "Should be 4 updates")
        self.assertEqual(len(loan.Loan.active_loans[1].debt_history_cad), 3, "Should be 3 updates")
        df_stats0 = loan.Loan.active_loans[0].stats
    ...
    def test_multiple_loans_multiple_updates_in_collateral_and_cad_borrowed(self):
        ...
        self.assertEqual(loan.Loan.active_loans[1].current_collateral, 10.0,
                         'Should be 10.0 in current collateral')
        self.assertEqual(loan.Loan.active_loans[0].current_debt_cad, 3000,
    ...
    def test_adding_new_row_to_stats(self):
        ...
        curr_interest_accrued = round(prev_interest_accrued + (loan.DAILY_INTEREST * loan0.current_debt_cad), 2)
